      ...
      <header className="sticky top-0 z-30 border-b border-white/8 bg-alliance-black/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4 px-5 py-4 sm:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/"
              className="hidden items-center gap-2 text-sm font-medium text-alliance-light/60 transition-colors hover:text-alliance-yellow sm:flex"
            >
              <HiArrowLeft />
              {t("login.backToSite")}
            </Link>
            ...
            return (
              ...
              >
                ...
                <div className="flex min-h-24 flex-1 flex-col gap-2.5 p-3">
                  {items.length === 0 ? (
                    <p className="py-8 text-center text-xs text-alliance-light/25">
                      {t("admin.empty")}
                    </p>
                  ) : (
                    items.map((lead) => (
